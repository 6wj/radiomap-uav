...
maxSigma1 = single(intmax); % The STD of cluster 1 should not be lower than this value
DEBUG_MODE = 1;

N = length(X);

% Initialization from a kariging
I1 = (S == 1);
I2 = (S == 2);
% Sigma2_1 = var(Z(I1)); Sigma2_2 = var(Z(I2));

maxloop = 1; cnt = 0; f = 1; f0 = 0; F = zeros(1, maxloop);
% EM loop begins --
