function Gr = powerMapReconKernel(R, Ydata, UE1PosMeter, DroneHeight, Maps, lambda)
% Power map reconstruction using kernel methods
% kernel function used: exp(- (x - x0)^2 / lambda)
...
if nargin < 6
    % some cross-validation to train lambda is needed!
end
